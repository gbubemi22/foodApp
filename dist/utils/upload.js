...
const uploadStreamToCloudinary = (buffer, publicId) => {
...
export const uploadToCloudinary = async (file) => {
    ...
    try {
        ...
        const result = await uploadStreamToCloudinary(file.data, publicId);
    ...
    try {
        ...
        for (const file of files) {
            ...
            if (file.size > maxFileSize) {
                throw new BadRequestError('File size exceeds the maximum allowed limit (5MB).');
            }
