...
import {
  listAll,
  listOneForCustomer,
  listFreshFoodForCustomer,
  listFoodForCustomer,
  listExtrasForCustomer,
} from "./service.js";
...
export const ListFreshFoodForCustomer: Controller = async (req, res, next) => {
  try {
     console.log("WHERE-2");
...
export const ListFoodForCustomer: Controller = async (req, res, next) => {
  try {
     console.log("WHERE-3");
...
export const ListExtrasForCustomer: Controller = async (req, res, next) => {
  try {
     console.log("WHERE-4");
