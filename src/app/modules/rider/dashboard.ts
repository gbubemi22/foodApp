...
export const allOrders = async (riderId: string) => {
...
export const stat = async (riderId: string) => {
...
export const getUserAverageRating = async (riderId: string) => {
...
export const activeDelivery = async (riderId: string) => {
