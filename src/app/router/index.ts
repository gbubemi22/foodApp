...
import CustomerItemRouter from "../modules/CustomerItem/index.js";
import RiderRouter from "../modules/rider/index.js";

const USER = `/v1/auth`;
const VENDOR = `/v1/vendor/auth`;
const ITEM = `/v1/items`;
const CUSTOMER_ITEM = `/v1/items/customers`;
const ADMIN = `/v1/admin/auth`;
const ADMINDASHBOARD = `/v1/dashboard`;
const ORDER = `/v1/orders`;
const STRIPE = `/v1/verify-payment`;
...
route.use(CUSTOMER_ITEM, CustomerItemRouter);
route.use(RIDER, RiderRouter);
