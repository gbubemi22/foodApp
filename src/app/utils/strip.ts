...
export const initiatePayment = async (
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `http://app.quickfoodshop.co.u/v1/success?session_id={CHECKOUT_SESSION_ID}`, // Include the protocol
      // Redirect URL after success
      cancel_url: `http://app.quickfoodshop.co.u/v1/cancel`, // Redirect URL after cancellation
      line_items: [
        {
          price_data: {
